...
export const LaptopReturnedConfirmation = () => {
    ...
    function getFormValues() {
        ...
        console.log(finalObjReceived)
        return finalObjReceived;
    }

    const addStock = () => {
        const values = getFormValues()
        axios.post(`${BASE_URL}/movements/confirm-receive`, values).then((response) => {
                console.log(response.data.data)
                Swal.fire({
                    icon: 'success',
                    title: 'Succès',
